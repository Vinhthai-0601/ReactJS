  ...
  return (
    <div class="bg-gray-100 py-10">
      <div class="flex flex-col mx-auto pl-5">
        <section class="flex gap-5 items-left">
          <a
            href="https://github.com/Vinhthai-0601"
          ...
          >
            <svg
              ...
              height="3em"
              viewBox="0 0 448 512"
              class="hover:h-14 hover:fill-yellow-500"
            >
          ...
          <a href="https://www.facebook.com/vinhthai.hau"
           class="transititext-primary text-primary transition duration-150 ease-in-out hover:text-primary-600 focus:text-primary-600 active:text-primary-700 dark:text-primary-400 dark:hover:text-primary-500 dark:focus:text-primary-500 dark:active:text-primary-600"
           data-te-toggle="tooltip"
           title="Phở Bò">
            <svg
          ...
          <a href="https://www.linkedin.com/in/vinh-thai-hau/"
           class="transititext-primary text-primary transition duration-150 ease-in-out hover:text-primary-600 focus:text-primary-600 active:text-primary-700 dark:text-primary-400 dark:hover:text-primary-500 dark:focus:text-primary-500 dark:active:text-primary-600"
           data-te-toggle="tooltip"
           title="Linkedin">
            <svg
